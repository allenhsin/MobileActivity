...
train = open('trainPCA','w')
test  = open('testPCA' ,'w')

INPUT_FILE_NAME0 = "trainClass0PCA"
INPUT_FILE_NAME1 = "trainClass1PCA"
INPUT_FILE_NAME2 = "trainClass2PCA"
INPUT_FILE_NAME3 = "trainClass3PCA"
INPUT_FILE_NAME4 = "trainClass4PCA"
with open(INPUT_FILE_NAME0) as f0:
	for line in f0:
		train.write(line)
with open(INPUT_FILE_NAME1) as f1:
...
INPUT_FILE_NAME0 = "testClass0PCA"
INPUT_FILE_NAME1 = "testClass1PCA"
INPUT_FILE_NAME2 = "testClass2PCA"
INPUT_FILE_NAME3 = "testClass3PCA"
INPUT_FILE_NAME4 = "testClass4PCA"
with open(INPUT_FILE_NAME0) as f0:
	for line in f0:
		test.write(line)
with open(INPUT_FILE_NAME1) as f1:
